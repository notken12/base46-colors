...
theme.set_highlights = function()
  ...
  hl(0, "IlluminatedWordWrite", { fg = 'NONE', bg = c.base02, sp = 'NONE',  })

  -- Dap
  hl(0, "DapBreakpoint", { fg = 'NONE', bg = c.red })
  hl(0, "DapBreakpointCondition", { fg = 'NONE', bg = c.yellow })
  hl(0, "DapBreakpointRejected", { fg = 'NONE', bg = c.orange })
  hl(0, "DapLogPoint", { fg = 'NONE', bg = c.cyan })
  hl(0, "DapStopped", { fg = 'NONE', bg = c.baby_pink })
  ...
  hl(0, "DapUISource", { fg = c.purple, bg = 'NONE' })
